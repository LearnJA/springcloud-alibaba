...
public class LogGateWayFilter implements GlobalFilter,Ordered {
    ...
    public LogGateWayFilter(ObjectMapper objectMapper) {
    ...
    private Mono<Void> authErro(ServerHttpResponse resp,String mess) {
        ...
        ResultEntity error = ResultEntity.error(mess, org.apache.http.HttpStatus.SC_UNAUTHORIZED);
        String returnStr = "";
        try {
            returnStr = objectMapper.writeValueAsString(error);
